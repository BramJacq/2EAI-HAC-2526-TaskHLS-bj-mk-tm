...
int main() {
    ...
    // Genereer een horizontale overgang (boven zwart, onder wit)
    ...
    // De HORIZONTALE randdetectie kernel (Rode matrix uit je opgave)
    ...
    cout << "Output op de horizontale rand (rij 64): " << (int)test_output[64 * IMG_COLS + 50] << " (Verwacht: Hoge waarde)" << endl;
    cout << "Output ver van de rand (rij 10): " << (int)test_output[10 * IMG_COLS + 50] << " (Verwacht: 0)" << endl;
