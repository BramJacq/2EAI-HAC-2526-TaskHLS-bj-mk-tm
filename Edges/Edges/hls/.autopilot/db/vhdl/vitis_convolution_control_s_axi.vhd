...
entity vitis_convolution_control_s_axi is
generic (
...
end entity vitis_convolution_control_s_axi;
...
architecture behave of vitis_convolution_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    signal kernel_shift0       : UNSIGNED(1 downto 0);
    signal int_kernel_shift0   : UNSIGNED(1 downto 0);

    component vitis_convolution_control_s_axi_ram is
        generic (
    ...
    end component vitis_convolution_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_kernel
int_kernel : vitis_convolution_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
-- ----------------------- Memory logic ------------------
    -- kernel
    int_kernel_address0  <= RESIZE(SHIFT_RIGHT(UNSIGNED(kernel_address0), 2), 2);
    int_kernel_ce0       <= kernel_ce0;
    kernel_q0            <= STD_LOGIC_VECTOR(RESIZE(SHIFT_RIGHT(int_kernel_q0, TO_INTEGER(int_kernel_shift0) * 8), 8));
    ...
    kernel_shift0        <= RESIZE(UNSIGNED(kernel_address0(1 downto 0)), 2);
...
entity vitis_convolution_control_s_axi_ram is
    generic (
        MEM_STYLE  : STRING :="auto";
        MEM_TYPE   : STRING :="S2P";
        BYTE_WIDTH : INTEGER :=8;
...
end entity vitis_convolution_control_s_axi_ram;

architecture behave of vitis_convolution_control_s_axi_ram is
