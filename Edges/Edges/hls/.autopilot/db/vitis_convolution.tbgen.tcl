...
set C_modelArgList {
	...
	{ output_img int 64 regular {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "input_img","offset": { "type": "dynamic","port_name": "input_img","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "input_img", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "output_img", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
...
set NewPortList {[ 
	...
	{ "name": "s_axi_control_r_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control_r", "role": "AWADDR" },"address":[{"name":"input_img","role":"data","value":"16"},{"name":"output_img","role":"data","value":"28"}] },
