set moduleName vitis_convolution
set isTopModule 1
...
set cdfgNum 6
set C_modelName {vitis_convolution}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict kernel { MEM_WIDTH 8 MEM_SIZE 9 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem_in int 8 regular {axi_master 0}  }
	{ gmem_out int 8 regular {axi_master 1}  }
	{ input_img int 32 regular {axi_slave 0}  }
	{ output_img int 32 regular {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "input_img","offset": { "type": "dynamic","port_name": "input_img","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "output_img","offset": { "type": "dynamic","port_name": "output_img","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "input_img", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "output_img", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "kernel", "interface" : "axi_slave", "bundle":"control","type":"ap_memory","bitwidth" : 8, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":31}} ]}
...
set portList { 
	...
	{ m_axi_gmem_in_AWADDR sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_gmem_in_ARADDR sc_out sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"vitis_convolution","role":"start","value":"0","valid_bit":"0"},{"name":"vitis_convolution","role":"continue","value":"0","valid_bit":"4"},{"name":"vitis_convolution","role":"auto_start","value":"0","valid_bit":"7"},{"name":"kernel","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"vitis_convolution","role":"start","value":"0","valid_bit":"0"},{"name":"vitis_convolution","role":"done","value":"0","valid_bit":"1"},{"name":"vitis_convolution","role":"idle","value":"0","valid_bit":"2"},{"name":"vitis_convolution","role":"ready","value":"0","valid_bit":"3"},{"name":"vitis_convolution","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_r_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control_r", "role": "AWADDR" },"address":[{"name":"input_img","role":"data","value":"16"},{"name":"output_img","role":"data","value":"24"}] },
...
set ArgLastReadFirstWriteLatency {
	vitis_convolution {
		...
		gmem_out {Type O LastRead 5 FirstWrite 4}
		input_img {Type I LastRead 7 FirstWrite -1}
		output_img {Type I LastRead 7 FirstWrite -1}
		kernel {Type I LastRead 8 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_0_0 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_0_1 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_0_2 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_1_0 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_1_1 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_1_2 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_2_0 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_2_1 {Type IO LastRead -1 FirstWrite -1}
		p_ZZ17vitis_convolutionPVhPVcPA3_cE11local_input_2_2 {Type IO LastRead -1 FirstWrite -1}
		local_output {Type IO LastRead -1 FirstWrite -1}}
	...
	vitis_convolution_Pipeline_Write_Rows_Write_Cols {
		gmem_out {Type O LastRead 5 FirstWrite 4}
		output_img {Type I LastRead 0 FirstWrite -1}
		local_output {Type I LastRead 2 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "48701", "Max" : "48701"}
	, {"Name" : "Interval", "Min" : "48702", "Max" : "48702"}
]}
