...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler vitis_convolution_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler vitis_convolution_control_r_s_axi BINDTYPE interface TYPE interface_s_axilite
}
