...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "input_img","offset": { "type": "dynamic","port_name": "input_img","bundle": "control_r"},"direction": "READONLY"},{"cName": "output_img","offset": { "type": "dynamic","port_name": "output_img","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
