...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.vitis_convolution.autotvin_gmem_in.dat"
         "c.vitis_convolution.autotvin_input_img.dat"
         "c.vitis_convolution.autotvin_output_img.dat"
         "c.vitis_convolution.autotvin_kernel.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.vitis_convolution.autotvout_gmem_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
