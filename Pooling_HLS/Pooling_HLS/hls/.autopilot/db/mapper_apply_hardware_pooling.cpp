...
using hls::sim::Byte;
extern "C" void apply_hardware_pooling(Byte<4>*, Byte<4>*, int, int, int, int, int);
extern "C" void apatb_apply_hardware_pooling_hw(volatile void * __xlx_apatb_param_invoer_pixels, volatile void * __xlx_apatb_param_uitvoer_pixels, int __xlx_apatb_param_breedte, int __xlx_apatb_param_hoogte, int __xlx_apatb_param_mode) {
...
__xlx_invoer_pixels__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_invoer_pixels)[i]);
  ...
  int __xlx_size_param_invoer_pixels = 1;
...
__xlx_uitvoer_pixels__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_uitvoer_pixels)[i]);
  ...
  int __xlx_size_param_uitvoer_pixels = 1;
  int __xlx_offset_param_uitvoer_pixels = 0;
  int __xlx_offset_byte_param_uitvoer_pixels = 0*4;
  // DUT call
  apply_hardware_pooling(__xlx_invoer_pixels__tmp_vec.data(), __xlx_uitvoer_pixels__tmp_vec.data(), __xlx_offset_byte_param_invoer_pixels, __xlx_offset_byte_param_uitvoer_pixels, __xlx_apatb_param_breedte, __xlx_apatb_param_hoogte, __xlx_apatb_param_mode);
