...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename rij_buffer_0 \
    op interface \
    ports { rij_buffer_0_address0 { O 8 vector } rij_buffer_0_ce0 { O 1 bit } rij_buffer_0_q0 { I 24 vector } rij_buffer_0_address1 { O 8 vector } rij_buffer_0_ce1 { O 1 bit } rij_buffer_0_q1 { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rij_buffer_0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename rij_buffer_1 \
    op interface \
    ports { rij_buffer_1_address0 { O 8 vector } rij_buffer_1_ce0 { O 1 bit } rij_buffer_1_q0 { I 24 vector } rij_buffer_1_address1 { O 8 vector } rij_buffer_1_ce1 { O 1 bit } rij_buffer_1_q1 { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rij_buffer_1'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln25_1 \
    op interface \
    ports { add_ln25_1 { I 32 vector } } \
} "
}
...
set InstName apply_hardware_pooling_flow_control_loop_pipe_sequential_init_U
set CompName apply_hardware_pooling_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix apply_hardware_pooling_ \
}"
} else {
