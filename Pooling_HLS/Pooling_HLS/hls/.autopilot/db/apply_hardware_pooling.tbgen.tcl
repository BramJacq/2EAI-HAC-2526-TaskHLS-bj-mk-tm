set moduleName apply_hardware_pooling
set isTopModule 1
...
set cdfgNum 6
set C_modelName {apply_hardware_pooling}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "invoer_pixels","offset": { "type": "dynamic","port_name": "invoer_pixels","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "uitvoer_pixels","offset": { "type": "dynamic","port_name": "uitvoer_pixels","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "invoer_pixels", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "uitvoer_pixels", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "breedte", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "hoogte", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "mode", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"apply_hardware_pooling","role":"start","value":"0","valid_bit":"0"},{"name":"apply_hardware_pooling","role":"continue","value":"0","valid_bit":"4"},{"name":"apply_hardware_pooling","role":"auto_start","value":"0","valid_bit":"7"},{"name":"breedte","role":"data","value":"16"},{"name":"hoogte","role":"data","value":"24"},{"name":"mode","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_CONTROL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "ARADDR" },"address":[{"name":"apply_hardware_pooling","role":"start","value":"0","valid_bit":"0"},{"name":"apply_hardware_pooling","role":"done","value":"0","valid_bit":"1"},{"name":"apply_hardware_pooling","role":"idle","value":"0","valid_bit":"2"},{"name":"apply_hardware_pooling","role":"ready","value":"0","valid_bit":"3"},{"name":"apply_hardware_pooling","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"invoer_pixels","role":"data","value":"16"},{"name":"uitvoer_pixels","role":"data","value":"28"}] },
...
set ArgLastReadFirstWriteLatency {
	apply_hardware_pooling {
		gmem_in {Type I LastRead 14 FirstWrite -1}
		gmem_out {Type O LastRead 26 FirstWrite 4}
	...
	apply_hardware_pooling_Pipeline_Read_Rij0 {
		gmem_in {Type I LastRead 1 FirstWrite -1}
		breedte {Type I LastRead 0 FirstWrite -1}
		sext_ln28 {Type I LastRead 0 FirstWrite -1}
		rij_buffer_0 {Type O LastRead -1 FirstWrite 2}}
	apply_hardware_pooling_Pipeline_Read_Rij1 {
		gmem_in {Type I LastRead 1 FirstWrite -1}
		breedte {Type I LastRead 0 FirstWrite -1}
		sext_ln32 {Type I LastRead 0 FirstWrite -1}
		rij_buffer_1 {Type O LastRead -1 FirstWrite 2}}
