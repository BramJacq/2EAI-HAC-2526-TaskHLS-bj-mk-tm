set moduleName apply_hardware_pooling_Pipeline_Pool_X
set isTopModule 0
...
set cdfgNum 6
set C_modelName {apply_hardware_pooling_Pipeline_Pool_X}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict rij_buffer_0 { MEM_WIDTH 24 MEM_SIZE 768 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict rij_buffer_1 { MEM_WIDTH 24 MEM_SIZE 768 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem_out int 32 regular {axi_master 1}  }
	{ add_ln25_1 int 32 regular  }
	{ sext_ln40 int 62 regular  }
	{ rij_buffer_0 int 24 regular {array 256 { 1 1 } 1 1 }  }
	{ rij_buffer_1 int 24 regular {array 256 { 1 1 } 1 1 }  }
	{ mode int 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "uitvoer_pixels","offset": { "type": "dynamic","port_name": "uitvoer_pixels","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "add_ln25_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln40", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "rij_buffer_0", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "rij_buffer_1", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln25_1 sc_in sc_lv 32 signal 1 } 
	{ sext_ln40 sc_in sc_lv 62 signal 2 } 
	{ rij_buffer_0_address0 sc_out sc_lv 8 signal 3 } 
	{ rij_buffer_0_ce0 sc_out sc_logic 1 signal 3 } 
	{ rij_buffer_0_q0 sc_in sc_lv 24 signal 3 } 
	{ rij_buffer_0_address1 sc_out sc_lv 8 signal 3 } 
	{ rij_buffer_0_ce1 sc_out sc_logic 1 signal 3 } 
	{ rij_buffer_0_q1 sc_in sc_lv 24 signal 3 } 
	{ rij_buffer_1_address0 sc_out sc_lv 8 signal 4 } 
	{ rij_buffer_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ rij_buffer_1_q0 sc_in sc_lv 24 signal 4 } 
	{ rij_buffer_1_address1 sc_out sc_lv 8 signal 4 } 
	{ rij_buffer_1_ce1 sc_out sc_logic 1 signal 4 } 
	{ rij_buffer_1_q1 sc_in sc_lv 24 signal 4 } 
	{ mode sc_in sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln25_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add_ln25_1", "role": "default" }} , 
 	{ "name": "sext_ln40", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln40", "role": "default" }} , 
 	{ "name": "rij_buffer_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rij_buffer_0", "role": "address0" }} , 
 	{ "name": "rij_buffer_0_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rij_buffer_0", "role": "ce0" }} , 
 	{ "name": "rij_buffer_0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rij_buffer_0", "role": "q0" }} , 
 	{ "name": "rij_buffer_0_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rij_buffer_0", "role": "address1" }} , 
 	{ "name": "rij_buffer_0_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rij_buffer_0", "role": "ce1" }} , 
 	{ "name": "rij_buffer_0_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rij_buffer_0", "role": "q1" }} , 
 	{ "name": "rij_buffer_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "address0" }} , 
 	{ "name": "rij_buffer_1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "ce0" }} , 
 	{ "name": "rij_buffer_1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "q0" }} , 
 	{ "name": "rij_buffer_1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "address1" }} , 
 	{ "name": "rij_buffer_1_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "ce1" }} , 
 	{ "name": "rij_buffer_1_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "q1" }} , 
 	{ "name": "mode", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mode", "role": "default" }}  ]}

set ArgLastReadFirstWriteLatency {
	apply_hardware_pooling_Pipeline_Pool_X {
		gmem_out {Type O LastRead -1 FirstWrite 4}
		add_ln25_1 {Type I LastRead 0 FirstWrite -1}
		sext_ln40 {Type I LastRead 0 FirstWrite -1}
		rij_buffer_0 {Type I LastRead 2 FirstWrite -1}
		rij_buffer_1 {Type I LastRead 2 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	add_ln25_1 { ap_none {  { add_ln25_1 in_data 0 32 } } }
	sext_ln40 { ap_none {  { sext_ln40 in_data 0 62 } } }
	rij_buffer_0 { ap_memory {  { rij_buffer_0_address0 mem_address 1 8 }  { rij_buffer_0_ce0 mem_ce 1 1 }  { rij_buffer_0_q0 mem_dout 0 24 }  { rij_buffer_0_address1 MemPortADDR2 1 8 }  { rij_buffer_0_ce1 MemPortCE2 1 1 }  { rij_buffer_0_q1 MemPortDOUT2 0 24 } } }
	rij_buffer_1 { ap_memory {  { rij_buffer_1_address0 mem_address 1 8 }  { rij_buffer_1_ce0 mem_ce 1 1 }  { rij_buffer_1_q0 mem_dout 0 24 }  { rij_buffer_1_address1 MemPortADDR2 1 8 }  { rij_buffer_1_ce1 MemPortCE2 1 1 }  { rij_buffer_1_q1 MemPortDOUT2 0 24 } } }
