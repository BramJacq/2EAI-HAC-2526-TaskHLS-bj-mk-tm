set moduleName apply_hardware_pooling_Pipeline_Read_Rij1
set isTopModule 0
...
set cdfgNum 6
set C_modelName {apply_hardware_pooling_Pipeline_Read_Rij1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict rij_buffer_1 { MEM_WIDTH 24 MEM_SIZE 768 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_in int 32 regular {axi_master 0}  }
	{ breedte int 31 regular  }
	{ sext_ln32 int 62 regular  }
	{ rij_buffer_1 int 24 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "invoer_pixels","offset": { "type": "dynamic","port_name": "invoer_pixels","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "rij_buffer_1", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ rij_buffer_1_address0 sc_out sc_lv 8 signal 3 } 
	{ rij_buffer_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ rij_buffer_1_we0 sc_out sc_logic 1 signal 3 } 
	{ rij_buffer_1_d0 sc_out sc_lv 24 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rij_buffer_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "we0" }} , 
 	{ "name": "rij_buffer_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rij_buffer_1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	rij_buffer_1 { ap_memory {  { rij_buffer_1_address0 mem_address 1 8 }  { rij_buffer_1_ce0 mem_ce 1 1 }  { rij_buffer_1_we0 mem_we 1 1 }  { rij_buffer_1_d0 mem_din 1 24 } } }
}
