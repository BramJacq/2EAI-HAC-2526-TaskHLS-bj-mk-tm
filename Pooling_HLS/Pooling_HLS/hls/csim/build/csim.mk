...
HLS_SOURCES = ../../../../pooling_tb.cpp ../../../../pooling.cpp
...
$(ObjDir)/pooling_tb.o: ../../../../pooling_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../pooling_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pooling_tb.d

$(ObjDir)/pooling.o: ../../../../pooling.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../pooling.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=apply_hardware_pooling $(IFLAG) $(DFLAG) $< -o $@ ; \
