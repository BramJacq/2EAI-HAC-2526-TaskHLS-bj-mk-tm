...
module apply_hardware_pooling_apply_hardware_pooling_Pipeline_Read_Rij1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   rij_buffer_1_we0;
output  [23:0] rij_buffer_1_d0;
...
reg   [8:0] x_1_reg_147_pp0_iter1_reg;
wire   [23:0] trunc_ln34_fu_127_p1;
reg   [23:0] trunc_ln34_reg_156;
wire   [63:0] zext_ln32_fu_131_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [8:0] x_fu_54;
wire   [8:0] add_ln32_fu_110_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_x_1;
wire    ap_block_pp0_stage0;
reg    rij_buffer_1_we0_local;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg    rij_buffer_1_ce0_local;
wire   [30:0] zext_ln32_1_fu_100_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln32_fu_104_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln32_fu_104_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        rij_buffer_1_we0_local = 1'b1;
    end else begin
        rij_buffer_1_we0_local = 1'b0;
    end
end
...
assign add_ln32_fu_110_p2 = (ap_sig_allocacmp_x_1 + 9'd1);
...
assign icmp_ln32_fu_104_p2 = ((zext_ln32_1_fu_100_p1 == breedte) ? 1'b1 : 1'b0);
...
assign rij_buffer_1_address0 = zext_ln32_fu_131_p1;

assign rij_buffer_1_ce0 = rij_buffer_1_ce0_local;

assign rij_buffer_1_d0 = trunc_ln34_reg_156;

assign rij_buffer_1_we0 = rij_buffer_1_we0_local;

assign trunc_ln34_fu_127_p1 = m_axi_gmem_in_0_RDATA[23:0];

assign zext_ln32_1_fu_100_p1 = ap_sig_allocacmp_x_1;

assign zext_ln32_fu_131_p1 = x_1_reg_147_pp0_iter1_reg;

endmodule //apply_hardware_pooling_apply_hardware_pooling_Pipeline_Read_Rij1
