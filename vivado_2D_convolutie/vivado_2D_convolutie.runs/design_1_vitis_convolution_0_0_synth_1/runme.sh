...
HD_PWD='C:/2EAI-HAC-2526-TaskHLS-bj-mk-tm/vivado_2D_convolutie/vivado_2D_convolutie.runs/design_1_vitis_convolution_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vitis_convolution_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vitis_convolution_0_0.tcl
