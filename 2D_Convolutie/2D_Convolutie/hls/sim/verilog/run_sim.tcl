...
if {[file isfile vitis_convolution.autotvin.dat]} {
	file delete -force vitis_convolution.autotvin.dat
}

if {[file isfile vitis_convolution.autotvout.dat]} {
	file delete -force vitis_convolution.autotvout.dat
}
