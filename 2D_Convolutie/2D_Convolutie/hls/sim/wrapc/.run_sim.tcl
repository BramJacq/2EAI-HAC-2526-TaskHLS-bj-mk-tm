...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vitis_convolution.autotvin.dat"
	set constFileTvOut       "vitis_convolution.autotvout.dat"
	set constFileHdlTvIn     "vitis_convolution.autohdltvin.dat"
	set constFileHdlTvOut    "vitis_convolution.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
