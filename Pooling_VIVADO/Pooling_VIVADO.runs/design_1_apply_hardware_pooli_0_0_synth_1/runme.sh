...
HD_PWD='C:/2EAI-HAC-2526-TaskHLS-bj-mk-tm/Pooling_VIVADO/Pooling_VIVADO.runs/design_1_apply_hardware_pooli_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_apply_hardware_pooli_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_apply_hardware_pooli_0_0.tcl
